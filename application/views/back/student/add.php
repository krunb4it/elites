<div id="main">
    ...
    <div id="main-content"> 
		<div class="page-title mb-3">
			<div class="row">
				...
				<div class="col-12 col-md-6 order-md-1 order-last">
					...
					<p class="text-subtitle text-muted">اضافة طالب جديد</p>
				</div>
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="student/add_student" class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
								...
								<div class="card-body">
									<div class="form-body"> 
										...
										<div class="row"> 
											...
											<div class="col-md-12 form-group">
												<input type="text" class="form-control" dir="ltr" name="student_name_en" required> 
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
											...
											<div class="col-md-12 form-group">
												<input type="tel" class="form-control" name="student_idno" required>
											</div>
										</div>
										...
										<div class="row"> 
											...
											<div class="col-md-12 form-group">
												<input type="text" class="form-control date" name="student_dob" required> 
											</div>
										</div>
									</div>
								</div> 
								...
								<div class="card-body">
									<div class="form-body">
										...
										<div class="row"> 
											...
											<div class="col-md-12 form-group">
												<input type="tel" class="form-control" name="student_tel" required> 
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
