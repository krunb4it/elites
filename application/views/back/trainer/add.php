<div id="main">
    ...
    <div id="main-content"> 
		<div class="page-title mb-3">
			<div class="row">
				...
				<div class="col-12 col-md-6 order-md-1 order-last">
					<h3>اضافة مدرب جديد</h3>
					<p class="text-subtitle text-muted">اضافة مدرب جديد</p>
				</div>
				<div class="col-12 col-md-6 order-md-2 order-first">
					<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">اضافة مدرب جديد</li> 
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="trainer/add_trainer" class="form form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
									...
									<div class="form-body"> 
										<div class="row"> 
											...
											<div class="col-md-12 form-group">
												<input type="text" class="form-control" name="trainer_name_ar" required> 
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
											...
											<div class="col-md-12 form-group">
												<input type="text" class="form-control" dir="ltr" name="trainer_name_en" required> 
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
											...
											<div class="col-md-12 form-group">
												<input type="tel" class="form-control" name="trainer_idno" required>
											</div>
										</div>
										...
										<div class="row"> 
											...
											<div class="col-md-12 form-group">
												<input type="text" class="form-control date" name="trainer_dob" required> 
											</div>
										</div>
									</div>
								</div> 
								...
								<div class="card-body">
									<div class="form-body">
										...
										<div class="row"> 
											...
											<div class="col-md-12 form-group">
												<input type="tel" class="form-control" name="trainer_phone" required> 
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
											...
											<div class="col-md-12 form-group">
												<input type="tel" class="form-control" name="trainer_tel" required> 
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
