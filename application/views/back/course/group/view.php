<div id="main">
    ...
    <div id="main-content"> 
		<div class="page-title mb-3">
			<div class="row">
				<div class="col-12 col-md-6 order-md-1 order-last">
					<h3>عرض المجموعة <?= $view->group_name?></h3> 
				</div>
				<div class="col-12 col-md-6 order-md-2 order-first">
					<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">عرض المجموعة <?= $view->group_name?></li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="course/course_group_update" class="form form-horizontal needs-validation" novalidate>
				<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
				<input type="hidden" name="course_available_id" value="<?=$view->course_available_id?>">
				<input type="hidden" name="course_group_id" value="<?=$view->course_group_id?>">
				<div class="row">
								...
								<div class="card-body">
									...
									<div class="row">
											...
											<div class="col-md-12 form-group"> 
												<input type="text" class="form-control" name="group_name" value="<?= $view->group_name?>" required>
										...
										<div class="row mb-3">
											...
											<div class="col-md-12 form-group">
												<select class="choices form-control" name="branch_id" required>
													...
													foreach($branch as $b){
													?>
													<option value="<?= $b->branch_id?>" <?php if($b->branch_id == $view->branch_id) echo "selected"?>><?= $b->branch_name?></option>
													<?php }?>
												</select>
										...
										<div class="row mb-3">
											...
											<div class="col-md-12 form-group">
												<select class="choices form-control" name="trainer_id" required>
													...
													?>
													<option value="<?= $t->trainer_id?>" <?php if($t->trainer_id == $view->trainer_id) echo "selected"?>><?= $t->trainer_name_ar?></option>
													<?php }?>
												</select>
										...
										<div class="row">
											...
											<div class="col-md-12 form-group">
												<textarea rows="5" class="form-control" name="group_note" ><?= strip_tags($view->group_note)?></textarea>
											</div>
										</div>
