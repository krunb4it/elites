		...
		<div class="page-title mb-3">
			<div class="row">
				<div class="col-12 col-md-6 order-md-1 order-last">
					<h3>طلاب المجموعة</h3>
					<p class="text-subtitle text-muted">عرض طلاب المجموعة<?= json_decode($info->course_title)->ar?></p>
				</div>
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							...
							<a class="btn btn-primary" href="course/course_group_add/<?= $info->course_available_id?>"> إنشاء مجموعة</a>
						</div>
						<div class="card-content">
							<div class="card-body">
								...
								<table class="table table-borderless mb-0">
									...
									?>
									<tr id="course_group_id_<?= $v->course_group_id;?>">
										<td ><?= $admin_img .'<i class="bi bi-clock mx-2"></i> '.$v->group_create_at?> </td> 
										<td ><?= $v->group_name?></td>
										<td ><?= $v->trainer_name_ar?></td>
										<td ><?= $v->branch_name?></td>
										<td ><?= count(get_sutdent_group($v->course_group_id))?></td>
										<td >
											<a href="course/course_group_view/<?= $v->course_group_id;?>/<?= $info->course_available_id?>" class="btb btn-sm btn-primary">تعديل</a>
											<a href="course/course_group_student/<?= $v->course_group_id?>/<?= $info->course_available_id?>" class="btb btn-sm btn-success">الطلاب</a>
										</td>
									</tr>
									<?php } ?>
								</table>
								<?php } else {?>
									<div class="alert alert-secondary">
                                        ...
                                        <p> لا يوجد مجموعات طلابية لهذه الدورة ، قم بإنشاء مجموعة</p> 
                                    </div>
								<?php }?>
							</div>
						</div>
