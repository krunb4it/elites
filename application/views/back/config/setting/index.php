									...
									<div class="form-body">
										<div class="row text-center mb-4">
											<div class="col-md-4">
												...
												<div class="text-center"> 
													<div class="upload-pic-box">
														<label for="website_icon" class="view-pic">
															<img src="<?= site_url().$view->website_icon?>" class="img-fluid rounded preview-pic" width="150">
														</label>
														<input type="file" class="form-control d-none upload-pic" id="website_icon" name="website_icon" id="formFile">
											...
											<div class="col-md-4">
												...
												<div class="upload-pic-box">
													<label for="website_logo" class="view-pic">
														<img src="<?= site_url().$view->website_logo?>" class="img-fluid rounded preview-pic" width="150">
													</label>
													<input type="file" class="form-control d-none upload-pic" id="website_logo" name="website_logo" id="formFile">
													<div class="invalid-feedback">الرجاء ارفاق صورة</div> 
												</div>	 
											...
											<div class="col-md-4">
												...
												<div class="upload-pic-box">
													<label for="website_cover" class="view-pic">
														<img src="<?= site_url().$view->website_cover?>" class="img-fluid rounded preview-pic" width="150">
													</label>
													<input type="file" class="form-control d-none upload-pic" id="website_cover" name="website_cover" id="formFile">
													<div class="invalid-feedback">الرجاء ارفاق صورة</div> 
												</div>
