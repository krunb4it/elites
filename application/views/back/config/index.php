					...
					<a href="<?= site_url()?>config/setting" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">إعدادت الموقع</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/contact" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">بيانات التواصل</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/social_media" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">التواصل الاجتماعي</h6> 
							</div>
						</div>
					</a>
				</div> 
					...
					<a href="<?= site_url()?>config/page" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">صفحات الموقع</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/language" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">لغات الموقع</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/payment_way" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">قنوات الدفع</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/users" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">المستخدمين</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/activites" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">نشاطات المستخدمين</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/slider" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">سلايدر الاعلانات</h6> 
							</div>
						</div>
					</a>
				</div>
					...
					<a href="<?= site_url()?>config/currency" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								...
								<h6 class="text-muted font-semibold mb-0">العملات</h6> 
							</div>
						</div>
					</a>
				</div>
				<div class="col-6 col-lg-3 col-md-6">
					<a href="<?= site_url()?>config/branch" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								<div class="stats-icon yellow">
									<i class="bi bi-geo-alt"></i>
								</div>
								<h6 class="text-muted font-semibold mb-0">الفروع</h6> 
							</div>
						</div>
					</a>
				</div>
				<div class="col-6 col-lg-3 col-md-6">
					<a href="<?= site_url()?>config/course" class="card mb-3">
						<div class="card-body p-4">
							<div class="d-flex align-items-center">  
								<div class="stats-icon dark">
									<i class="bi bi-tags"></i>
								</div>
								<h6 class="text-muted font-semibold mb-0">الدورات</h6> 
							</div>
						</div>
					</a>
				</div>
