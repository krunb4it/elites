...
<div id="main">
    ...
    <div id="main-content"> 
				...
				<div class="col-12 col-md-6 order-md-2 order-first">
					<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">اضافة مستوى <?= $courseName?></li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="page-heading"> 
			<form id="form" method="post" action="config/add_level" class="form form-horizontal needs-validation" novalidate>
								...
								<div class="card-body">
									<div class="form-body">
										...
										<div class="row"> 
											...
											<div class="col-md-9 form-group">
												<input type="text" class="form-control" name="level_hours" required > 
											</div>
										</div> 
										<div class="row"> 
											<div class="col-md-3">
											...
											<div class="col-md-9 form-group">
												<input type="text" class="form-control" name="level_price" required > 
											</div>
										</div>
